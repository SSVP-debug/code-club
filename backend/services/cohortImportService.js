 ...
 *   { archived: true }                  — the cohort is archived (frozen roster — see cohortMembershipService.js's addStudentToCohort for the shared reasoning); rejected before the file is even parsed
